...
def _salvar_tokens(access_token, refresh_token, expires_at):
...
def _carregar_tokens():
    # Tenta carregar do arquivo; se não existir, tenta da variável de ambiente
...
def get_tokens_json_str():
    """Retorna o conteúdo atual de tokens.json como string (para salvar no secret)."""
    with open(TOKEN_FILE) as f:
        return f.read()
